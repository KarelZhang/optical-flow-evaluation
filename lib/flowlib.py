...
def compute_flow_error(tu, tv, u, v):
    """
    Calculate average end point error
    :param tu: ground-truth horizontal flow map
    :param tv: ground-truth vertical flow map
...
def evaluate_flow_file(gt_file, pred_file):
    ...
    # Calculate errors
    average_pe = compute_flow_error(gt_flow[:, :, 0], gt_flow[:, :, 1], eva_flow[:, :, 0], eva_flow[:, :, 1])
    return average_pe
...
def evaluate_flow(gt_flow, pred_flow):
    ...
    pred: estimated flow
    """
    average_pe = compute_flow_error(gt_flow[:, :, 0], gt_flow[:, :, 1], pred_flow[:, :, 0], pred_flow[:, :, 1])
    return average_pe
