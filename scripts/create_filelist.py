...
parser.add_argument('format', type=str, default='.png', help="The format of the files you want to search for")
parser.add_argument("--input_dir", type=str, default='/meida/zhangjiaao/data/flow/kitti2015/trainig/image_2',help="The directory to search for flow files")
